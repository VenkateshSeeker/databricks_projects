...
This folder defines all source code for the 'retail_data_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_retail_data_pipeline.py" to get familiar with the syntax.
